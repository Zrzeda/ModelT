...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/training/electronics/en",
						"https://electronics.local:9002/training/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/training/electronics/en",
						"https://electronics.local:9002/training/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/training/electronics/ja/Y/Z",
						"https://electronics.local:9002/training/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/training/electronics/en",
						"https://electronics.local:9002/training/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/training",
						"https://electronics.local:9002/training"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/training",
						"https://electronics.local:9002/training/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/training/electronics/en",
						"https://electronics.local:9002/training/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
